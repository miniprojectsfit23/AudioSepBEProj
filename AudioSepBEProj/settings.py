"""
Django settings for AudioSepBEProj project.
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1',
                 'disease-detection-ml.herokuapp.com']
...
ROOT_URLCONF = 'AudioSepBEProj.urls'
...
WSGI_APPLICATION = 'AudioSepBEProj.wsgi.application'
